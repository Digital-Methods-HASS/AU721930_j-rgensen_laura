...
list.files(path = "data/breve_oxe", pattern = "pdf")
```
```{r}
#Følger guiden fra software carpentry 
list.files(path = "data/breve_oxe", pattern = "breve_Oxe, Pernille", full.names = TRUE)
```
```{r}
#Følger guiden fra software carpentry 
filenames <- list.files(path = "data/breve_oxe",  
                        pattern = "breve_Oxe, Pernille-[0-9]{2}.pdf",
                        full.names = TRUE)
for (f in filenames) {
  print(f)
  analyze(f)
